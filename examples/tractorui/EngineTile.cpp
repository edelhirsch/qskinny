    ...
    : Tile( "engine", parent )
{
    ...
    auto* speed = new Speedometer( UnitConversion::UnitType::Speed, speedBox );
    ...
    auto* drive = new Speedometer( UnitConversion::UnitType::None, driveBox );
    drive->setExplicitUnitString( tr("*100 rpm") );
