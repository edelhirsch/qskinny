...
{        
    ...
    // Glow: sharper falloff, more vibrant color
    float glow = 1.0 - smoothstep( 0.0, ubuf.blurRadius * 0.7, dist );
    glow = pow(glow, 1.5); // make the glow more pronounced
    fragColor = ubuf.color * glow * ubuf.opacity;
} 