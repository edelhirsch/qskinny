...
namespace
{
    class Material final : public QSGMaterial
    {
      public:
        ...
        QVector4D m_color { 1, 1, 0, 1 }; // default: yellowish glow
        QVector4D m_arc = {};
    ...
    class ShaderRhi final : public RhiShader
    {
      public:
        ShaderRhi()
        {
            ...
            setShaderFileName( FragmentStage, root + "arcglow.frag.qsb" );
        }
    ...
    class ShaderGL final : public QSGMaterialShader
    {
      ...
      public:
        ShaderGL()
        {
            ...
            setShaderSourceFile( QOpenGLShader::Fragment, root + "arcglow.frag" );
        }
...
class ArcGlowMaterial final : public QSGMaterial
{
  public:
    ArcGlowMaterial();
    ~ArcGlowMaterial() override;
...
ArcGlowMaterial::ArcGlowMaterial()
{
    setFlag( QSGMaterial::Blending, true );
#if QT_VERSION < QT_VERSION_CHECK( 6, 0, 0 )
    setFlag( QSGMaterial::SupportsRhiShader, true );
...
ArcGlowMaterial::~ArcGlowMaterial() = default;

QSGMaterialType* ArcGlowMaterial::type() const
{
...
#if QT_VERSION < QT_VERSION_CHECK( 6, 0, 0 )
QSGMaterialShader* ArcGlowMaterial::createShader() const
{
...
#else
QSGMaterialShader* ArcGlowMaterial::createShader( QSGRendererInterface::RenderMode ) const
{
    return new ShaderRhi();
}
#endif

int ArcGlowMaterial::compare( const QSGMaterial* other ) const
{
    auto material = static_cast< const ArcGlowMaterial* >( other );
...
class ArcGlowNodePrivate final : public QSGGeometryNodePrivate
{
  public:
    ArcGlowNodePrivate()
    ...
    ArcGlowMaterial material;
    QRectF rect;
};

ArcGlowNode::ArcGlowNode()
    : QSGGeometryNode( *new ArcGlowNodePrivate )
{
    Q_D( ArcGlowNode );
...
void ArcGlowNode::setBoundingRectangle(const QRectF& rect)
{
    Q_D(ArcGlowNode);
    if (rect != d->rect)
    {
